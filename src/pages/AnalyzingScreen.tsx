...
const analysisSteps = [
  ...
  {
    label:
      "Calculating borrowing affordability",
    icon: TrendingUp,
  },
  {
    label:
      "Running income stress tests",
    icon: ShieldCheck,
  },
  {
    label:
...
export default function AnalyzingScreen({
  ...
  /*
   * Prevents onComplete from firing more than once,
      ...
      <section className="w-full max-w-xl">
        ...
        <div className="rounded-3xl border border-[#E6DFE2] bg-white p-7 shadow-sm sm:p-10">
          ...
          <p className="mt-6 text-sm leading-7 text-[#756A70]">
            We are evaluating affordability,
            borrowing costs, and potential
            financial pressure based on the
